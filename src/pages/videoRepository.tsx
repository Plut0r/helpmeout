    ...
    <div className="pt-8">
      ...
      <div className="container flex items-center justify-between">
        <div className="flex flex-col gap-2">
          <h1 className="sora text-[2rem] font-bold text-[#141414]">
            Hello, John Mark
          </h1>
          <p className="workSans font-normal text-lg text-[rgba(20,20,20,0.70)]">
            Here are your recorded videos
          </p>
        </div>
        <div className="w-[25rem] h-14 rounded-xl border border-[#E7E7ED] bg-[rgba(182,179,198,0.14)] flex items-center gap-4 px-5">
          <div>

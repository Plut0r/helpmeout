export function LastSection() {
  return (
    <div className="py-5 my-24 w-full bg-[rgba(231,231,237,0.20)] flex flex-col gap-8 items-center justify-center">
      <h3 className="sora text-2xl font-semibold text-[#141414]">
        To ensure the availability and privacy of your video, <br /> we
        recommend saving it to your account.
      </h3>
      <button className="bg-[#120B48] p-4 rounded-lg workSans text-[#F9F9FF] text-base font-medium">
        Save Video
      </button>
      <div className="flex items-center gap-1">
        <div className="sora text-2xl font-semibold text-[#7E7E7E]">
          Don't have an account?
        </div>
        <div className="sora text-2xl font-semibold text-[#120B48] cursor-pointer">
          Create account
        </div>
      </div>
    </div>
...
function Recording() {
  return (
    <div className="container flex gap-20 my-8">
      <div className="flex-1 flex flex-col gap-7">
        <h1 className="sora text-[2.8125rem] font-bold text-[#141414]">
          Your Video is ready!
        </h1>
        <div className="flex flex-col gap-2">
          <h2 className="sora text-[#727272] text-base font-medium">Name</h2>
          <div className="flex items-center gap-3">
            <div className="sora text-2xl font-semibold text-[#413C6D]">
        ...
        <div className="bg-[rgba(182,179,198,0.20)] border border-[rgba(231,231,237,0.5)] rounded-2xl w-full h-14 mt-5 flex items-center justify-between px-5">
          <input
            type="text"
        ...
        <div className="mt-5 flex flex-col gap-4">
          ...
          <div className="w-full h-14 rounded-2xl bg-[#FAFAFA] border border-[#929292] flex items-center justify-between px-5">
            ...
            <div className="rounded-lg px-[0.625rem] py-2 border border-[#120B48] flex items-center justify-center gap-2">
              ...
              <p className="sora text-base font-medium text-[#120B48]">Copy</p>
            </div>
          </div>
        </div>
        <div className="mt-5 flex flex-col gap-4">
